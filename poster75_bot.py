...
# Less frequent autosave reduces IO/CPU overhead
...
STR = {
    ...
    'welcome_first_time': "🎉 𝐁𝐨𝐭𝐚 𝐡𝐨𝐬̧ 𝐠𝐞𝐥𝐝𝛊𝐧! 𝐈𝐥𝐤𝛊𝐧𝐜𝛊 𝐮𝐥𝐚𝐧𝐲𝐬̧𝐲𝐧 𝐮𝐜𝛊𝐧 𝐬𝐞𝐧𝛊𝐧 𝐛𝐚𝐥𝐚𝐧𝐬𝐲𝐧𝐚 30 𝐣𝐞𝐭𝐨𝐧 𝐬𝐨𝐯𝐠𝐚𝐭 𝐞𝐝𝛊𝐥𝐝𝛊. 🎁",
    ...
    'edit_prompt': "📝 𝐓𝐚̂𝐳𝐞 𝐭𝐞𝐤𝐬𝐭𝛊 𝐲́𝐚𝐳𝐲𝐧 𝐲́𝐚 𝐝𝐚 𝐬𝐚𝐧 𝐠𝛊𝐫𝛊𝐳𝛊𝐩 𝐰𝐚𝐠̆𝐭𝐲 𝐮̈𝐲́𝐭𝐠𝐞𝐝𝛊𝐧 ( 𝛊𝐧 𝐚𝐳 {min} — 𝛊𝐧 𝐤𝐨̈𝐩 {max}).".format(min=MIN_SECOND, max=MAX_SECOND),
    ...
    'fill_account_text': "𝐒𝐚𝐥𝐚𝐦 — 𝐛𝐨𝐭𝐲𝐦𝐲𝐳𝐲𝐧 𝐬𝛊𝐳𝛊𝐧 𝐤𝐚𝐧𝐚𝐥𝐲𝐧𝐲𝐳𝐚 𝐩𝐨𝐬𝐭 𝐮𝐠𝐫𝐚𝐭𝐦𝐚𝐬𝐲 𝐮̈𝐜̧𝛊𝐧 𝐡𝐚𝐬𝐚𝐛𝐲𝐧𝐲𝐳𝐲 𝐝𝐨𝐥𝐝𝐲𝐫𝐲𝐧.\n\n"
        ...
        "𝐈𝐥𝐤𝛊 𝐛𝛊𝐥𝐞𝐧 𝐬̧𝐮 𝐧𝐨𝐦𝐞𝐫𝐚 𝐩𝐮𝐥 𝐠𝐞𝐜̧𝛊𝐫𝛊𝐧 : +99363222850. 𝐒𝐨𝐧𝐫𝐚 𝐠𝐞𝐜̧𝛊𝐫𝛊𝐦𝛊𝐧 ( 𝐬𝐤𝐫𝛊𝐧𝐬̧𝐨𝐭𝐲𝐧𝐲 ) 𝐜̧𝐞𝐠𝛊𝐧𝛊 𝐚𝐝𝐦𝛊𝐧𝐚 𝐮𝐠̆𝐫𝐚𝐝𝐲𝐧‼️\n\n"
    ...
    'topup_success_owner': "✅ @{username} 𝐮𝐥𝐚𝐧𝐲𝐣𝐲𝐬𝐲𝐧𝐚 {amount} 𝐣𝐞𝐭𝐨𝐧 𝐮̈𝐬𝐭𝐮̈𝐧𝐥𝛊𝐤𝐥𝛊 𝐠𝐨𝐬̧𝐲𝐥𝐝𝐲. 𝐓𝐚̂𝐳𝐞 𝐁𝐚𝐥𝐚𝐧𝐬𝐲: {new}.",
    'topup_success_user_notify': "🎉 𝐀𝐝𝐦𝛊𝐧 @{admin} 𝐭𝐚𝐫𝐚𝐩𝐲𝐧𝐝𝐚𝐧 𝐬𝛊𝐳𝛊𝐧 𝐡𝐚𝐬𝐚𝐛𝐲𝐧𝐲𝐳𝐚 {amount} 𝐣𝐞𝐭𝐨𝐧 𝐠𝐨𝐬̧𝐮𝐥𝐝𝐲.\n𝐓𝐚̂𝐳𝐞 𝐛𝐚𝐥𝐚𝐧𝐬: {new}.",
    ...
    'about_text': "🤖 𝐁𝐮 𝐛𝐨𝐭 @Kodd_75 𝐭𝐚𝐫𝐚𝐩𝐲𝐧𝐝𝐚𝐧 𝐝𝐨̈𝐫𝐞𝐝𝛊𝐥𝐞𝐧𝐝𝛊𝐫.\n📌 𝐄𝐠𝐞𝐫-𝐝𝐞 𝐬𝛊𝐳𝐞𝐝𝐞 𝐬𝐞𝐲́𝐥𝐞 𝐛𝐨𝐭 𝐠𝐞𝐫𝐞𝐤 𝐛𝐨𝐥𝐬𝐚 𝐡𝐚𝐛𝐚𝐫𝐥𝐚𝐬̧𝐲𝐧.\n✉️ 𝐃𝐮̈𝐬̧𝐧𝛊𝐤𝐬𝛊𝐳𝐥𝛊𝐤 𝐲́𝐚 𝐝𝐚 𝐬𝐨𝐫𝐚𝐠𝐥𝐚𝐫𝐲𝐧𝐲𝐳 𝐛𝐚𝐫 𝐛𝐨𝐥𝐬𝐚, 𝐛𝛊𝐳𝐞 𝐲́𝐚𝐳𝐲𝐩 𝐛𝛊𝐥𝐞𝐫𝐬𝛊𝐧𝛊𝐳 : @Kodd_75\n💫 𝐒𝛊𝐳𝛊𝐧 𝐮̈𝐜̧𝛊𝐧 𝐤𝐨̈𝐦𝐞𝐠𝐞 𝐭𝐚𝐲́𝐲́𝐚𝐫‼️",
    'admin_unlimited_prompt': "♾️ 𝐔𝐥𝐚𝐧𝐲𝐣𝐲 𝐚𝐝𝐲𝐧𝐲𝐧 𝐠𝛊𝐫𝛊𝐳𝛊𝐧 ( 𝐦𝐲𝐬𝐚𝐥: @username 𝐲́𝐚 𝐝𝐚 𝛊𝐝 ):",
    'admin_unlimited_added': "✅ @{username} 𝐮𝐥𝐚𝐧𝐲𝐣𝐲𝐬𝐲𝐧𝐚 𝐥𝛊𝐦𝛊𝐭𝐬𝛊𝐳 𝐣𝐞𝐭𝐨𝐧 𝐡𝐮𝐤𝐮𝐠𝐲 𝐛𝐞𝐫𝛊𝐥𝐝𝛊.",
    'admin_unlimited_removed': "✅ @{username} 𝐮𝐥𝐚𝐧𝐲𝐣𝐲𝐬𝐲𝐧𝐲𝐧 𝐥𝛊𝐦𝛊𝐭𝐬𝛊𝐳 𝐣𝐞𝐭𝐨𝐧 𝐡𝐮𝐤𝐮𝐠𝐲 𝐚𝐲́𝐫𝐲𝐥𝐝𝐲.",
    ...
    async with file_lock:
        try:
            data = {
                ...
                "usernames": {k: v for k, v in usernames.items()},
                "unlimited_users": [int(u) for u in unlimited_users]
            }
            # atomic write
            tmp = DATA_FILE + ".tmp"
    ...
    try:
        async with file_lock:
            with open(DATA_FILE, "r", encoding="utf-8") as f:
                ...
                balances.update({int(k): int(v) for k, v in data.get("balances", {}).items()})
                usernames.update({k.lower(): int(v) for k, v in data.get("usernames", {}).items()})
                unlimited_users = set(int(u) for u in data.get("unlimited_users", []))
        posts_by_id = {}
        _post_heap.clear()
        now = time.time()
        cnt = _heap_counter
        for p in scheduled_posts:
            ...
            if pid is None:
                continue
            posts_by_id[pid] = p
            nt = p.get("next_time", now)
            heapq.heappush(_post_heap, (nt, next(cnt), pid))
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("post_"):
        ...
        controls = [
            ...
            InlineKeyboardButton("▶ 𝐃𝐨𝐯𝐚𝐦" if post.get('paused') else "⏸ 𝐃𝐮𝐫𝐮𝐳", callback_data=f"toggle_{post_id}"),
        ]
...
async def message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in waiting_for:
            ...
            async with data_lock:
                ...
                if text and text.isdigit():
                    ...
                    if stickers:
                        ...
                        await update.message.reply_text("✅ 𝐒𝐭𝛊𝐤𝐞𝐫𝐥𝐞𝐫 𝐠𝐨𝐬̧𝐮𝐥𝐝𝐲.", reply_markup=back_menu())
                mark_dirty()
            waiting_for.pop(user_id, None)
            return
        ...
        if step == "broadcast_message":
            ...
            success = 0
            failed = 0
            # send with small pause to reduce burst CPU/network
            for uid in user_ids:
                try:
...
async def scheduler(app):
    ...
    while True:
        ...
        # wait but allow waking if new earlier post added
        try:
        ...
        try:
            ...
            if owner not in unlimited_users:
                ...
                if owner_balance <= 0:
                    # pause owner's posts efficiently (single pass)
                    async with data_lock:
                        for p in scheduled_posts:
            ...
            if sent_success:
                ...
                for st in stickers:
                    try:
                        ...
                        pass
                    # small pause so large sticker lists don't hog CPU/network
        ...
        # yield briefly to keep loop cooperative
...
async def ram_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(s('ram_info', total=vm, proc=mem))
...
async def main():
    ...
    # create tasks outside handlers; application will manage lifecycle
    app.create_task(scheduler(app))
    app.create_task(auto_save_task())
